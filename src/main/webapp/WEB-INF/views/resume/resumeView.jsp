...
<body>
<h1>지원서 작성하기</h1>
<h4>[포스코DX 채용] 회사 부서[부서명 어떻게 가져오지..]</h4>
...
<div>
  ...
  <input type="email" id="email" name="email" value="${userInfo.getEmail()}" required>

  <label for="birthday">생년월일:</label>
  <input type="text" id="birthday" name="birthday" value="${userInfo.getBirthday()}" required>

  <label for="address">주소:</label>
  <input type="text" id="address" name="address" value="${userInfo.getAddress()}" required>
</div>
